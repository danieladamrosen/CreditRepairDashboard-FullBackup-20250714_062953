...
export function PublicRecordsSection({
  ...
  const handleToggle = () => {
    const newExpanded = !publicRecordsCollapsed;
    ...
    <div className="mb-4">
      {publicRecordsCollapsed ? (
        <Card
          ...
          onClick={() => {
            console.log("Public Records header clicked — scrolling to public-records");
            
            // Smooth scroll to Public Records section
            const publicRecordsSection = document.querySelector('[data-section="public-records"]') as HTMLElement;
            if (publicRecordsSection) {
              const elementTop = publicRecordsSection.getBoundingClientRect().top + window.scrollY - 20;
              ...
              console.warn("Public Records section with data-section='public-records' not found");
            }
