        ...
        >
          ...
          <div className="flex gap-2 justify-between items-center pt-4">
            ...
            <div className="flex items-center gap-2 relative overflow-visible">
              ...
              {isDisputeSavedState ? (
                <div className="flex items-center justify-center w-8 h-8 rounded-full bg-green-600 mr-1">
                  <ThickCheckIcon className="w-4 h-4 text-white" />
                </div>
              ) : (
                <span className="circle-badge-blue mr-1">
                  3
                </span>
              )}
              <Button
                onClick={() => {
                  ...
                  if (isRecent) {
                    ...
                    // Recent Inquiries choreography: Show green feedback but do NOT auto-collapse
                    // The Hard Inquiries choreography in hard-inquiries-section.tsx will handle the scroll/collapse sequence
                    console.log("Step 1: Recent Inquiries Marked Saved");
                    
                    // Show green feedback for 1 second, then allow manual toggle
                    setTimeout(() => {
                      console.log("Step 2: Recent Inquiries Choreography Complete - Manual Toggle Available");
                      // Recent Inquiries stays expanded for manual toggle
                      // Hard Inquiries choreography will handle the rest
                    }, 1000);
                    ...
                    // Older Inquiries choreography: Show green feedback but do NOT auto-collapse
                    // The Hard Inquiries choreography in hard-inquiries-section.tsx will handle the scroll/collapse sequence
                    console.log("Step 1: Older Inquiries Marked Saved");
                    
                    // Show green feedback for 1 second, then allow manual toggle
                    setTimeout(() => {
                      console.log("Step 2: Older Inquiries Choreography Complete - Manual Toggle Available");
                      // Older Inquiries stays expanded for manual toggle
                      // Hard Inquiries choreography will handle the rest
                    }, 1000);
                  }
                }}
      ...
      {showCombinedCollapsedBox &&
        (combinedInfo.hasOlderDispute || combinedInfo.hasRecentDispute) && (
          <Card className="border border-green-300 bg-green-50 transition-all duration-300">
            <CardHeader
              className="cursor-pointer transition-colors min-h-[72px] flex items-center hover:bg-green-100"
              onClick={() => {
      ...
      {!showCombinedCollapsedBox && (
        <>
          ...
          <Card
            ...
            className={`transition-all duration-300 hover:shadow-lg ${showOlderInquiries ? 'border-2 border-gray-300 rounded-lg pb-6' : 'border border-gray-200 rounded-lg'} ${isOlderDisputeSaved ? 'bg-green-50 border-[2px] border-green-500 rounded-lg' : 'bg-white'}`}
          >
            <CardHeader
              className={
                isOlderDisputeSaved 
                  ? `cursor-pointer flex flex-row items-center p-6 bg-green-50 hover:bg-green-100 transition-colors duration-200 ${showOlderInquiries ? 'rounded-t-lg' : 'rounded-lg'}`
                  : `cursor-pointer flex flex-row items-center p-6 bg-white hover:bg-gray-50 transition-colors duration-200 ${showOlderInquiries ? 'rounded-t-lg' : 'rounded-lg'}`
              }
              ...
              <div className="flex justify-between items-center w-full">
                <div className="flex items-center gap-3">
                  ...
                  <div className={isOlderDisputeSaved ? "mt-0.5" : ""}>
                    ...
                    <p className={`text-sm ${isOlderDisputeSaved && !showOlderInquiries ? 'text-green-700' : 'text-green-600'}`}>
            ...
            {showOlderInquiries && (
              <div className={`w-[1150px] max-w-[1150px] mx-auto rounded-lg p-6 ${isOlderDisputeSaved ? 'bg-green-50 border-2 border-green-500' : Object.values(selectedOlderInquiries).some(Boolean) ? 'bg-rose-50 border-2 border-red-500' : 'bg-gray-50 border-2 border-gray-300'}`}>
          ...
          <Card
            ...
            className={`transition-all duration-300 hover:shadow-lg ${effectiveShowRecentInquiries ? 'border-2 border-gray-300 rounded-lg pb-6' : 'border border-gray-200 rounded-lg'} ${isRecentDisputeSaved ? 'bg-green-50 border-[2px] border-green-500 rounded-lg' : 'bg-white'}`}
          >
            <CardHeader
              data-testid="recent-inquiries-header"
              className={
                isRecentDisputeSaved 
                  ? `cursor-pointer flex flex-row items-center p-6 bg-green-50 hover:bg-green-100 transition-colors duration-200 ${effectiveShowRecentInquiries ? 'rounded-t-lg' : 'rounded-lg'}`
                  : `cursor-pointer flex flex-row items-center p-6 bg-white hover:bg-gray-50 transition-colors duration-200 ${effectiveShowRecentInquiries ? 'rounded-t-lg' : 'rounded-lg'}`
              }
              onClick={() => {
            ...
            {effectiveShowRecentInquiries && (
              <div className={`w-[1150px] max-w-[1150px] mx-auto rounded-lg p-6 ${isRecentDisputeSaved ? 'bg-green-50 border-2 border-green-500' : Object.values(selectedRecentInquiries).some(Boolean) ? 'bg-rose-50 border-2 border-red-500' : 'bg-gray-50 border-2 border-gray-300'}`}>
