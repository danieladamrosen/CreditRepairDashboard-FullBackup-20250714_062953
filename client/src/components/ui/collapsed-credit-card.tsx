      ...
      <CardHeader
        ...
        onClick={() => {
          ...
          if (creditAccountsSection) {
            const elementTop = creditAccountsSection.getBoundingClientRect().top + window.scrollY - 20;
            ...
            console.warn("Credit Accounts section with data-section='credit-accounts' not found");
          }
          
          // Then handle toggle and expand
          onToggle();
          if (!isOpen && onExpand) {
            onExpand();
          }
